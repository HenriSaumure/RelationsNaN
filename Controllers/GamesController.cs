...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var game = await _context.Game.Include(g => g.Platforms).Include(g => g.Genre)
        ...
        .FirstOrDefaultAsync(g => g.Id == id);
            ...
            ViewData["GenreId"] = new SelectList(_context.Genre, "Id", "Name", game.GenreId);
            ViewData["Platforms"] = new SelectList(_context.Platform.Where(p => !game.Platforms.Select(gp => gp.Id).Contains(p.Id)),"Id", "Name");
            return View(game);
        }
